...
public class MySmsClient extends OzSmsClient{

	public MySmsClient(String host, int port) throws IOException,
	...
	public void doOnMessageReceived(OzSMSMessage sms) {
	 Date now = new Date();
	 System.out.println(now.toString() + " Message received. Sender address: " + sms.sender + " Message text: " + sms.messageData);
	}
	@Override
